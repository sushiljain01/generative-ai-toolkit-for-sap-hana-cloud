"""
This module contains the tools for massive automatic timeseries.
...
class MassiveAutomaticTimeSeriesFitAndSave(BaseTool):
    """
    This tool fits a massive time series model and saves it in the model storage.
    ...
    str
        ...
        .. note::
            ...
            .. list-table::
                ...
                * - group_key
                  - The name of the group column for multiple time series. If not provided, ask the user. Do not guess.
                * - endog
